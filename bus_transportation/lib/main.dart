import 'package:bus_transportation/Login/login_page.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        colorScheme: ColorScheme.fromSeed(seedColor: CustomColors.themeColors),
        useMaterial3: true,
        appBarTheme: const AppBarTheme(color: CustomColors.themeColors)
      ),
